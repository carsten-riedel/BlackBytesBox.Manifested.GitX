...
#RequiredModules = @(@{ModuleName = 'CoreePower.Lib'; ModuleVersion = '0.20251.11308'; })
...
FunctionsToExport = @('Get-GitTopLevelDirectory','Get-GitCurrentBranch','Get-GitRepositoryName')
...
AliasesToExport = @('ggtd','ggcb','ggrn')
