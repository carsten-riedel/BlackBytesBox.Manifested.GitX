...
#RequiredModules = @(@{ModuleName = 'CoreePower.Lib'; ModuleVersion = '0.20252.17956'; })
...
AliasesToExport = @('ggtd','ggcb','ggrn','cgrs','grrfi','grrf','clrft','ggcbr','srrf','gglr','ggrfm','sgrf','mirror-grwdc')
